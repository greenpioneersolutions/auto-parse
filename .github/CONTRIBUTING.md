...
* Please make sure that your contribution fits well in the project's style & concept:
  ...
  * [Pass All Test](https://travis-ci.org/greenpioneersolutions/auto-parse)

## Creating an Issue

Before you create a new Issue:
* Check the [Issues](https://github.com/greenpioneersolutions/auto-parse/issues) on Github to ensure one doesn't already exist.
